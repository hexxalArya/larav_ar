...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="#page-top">Website Jembatan Akar</a>
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <!-- Masthead Heading-->
        <h1 class="masthead-heading text-uppercase mb-0">Jembatan Akar</h1>
        <!-- Icon Divider-->
        ...
        <!-- Masthead Subheading-->
        <p class="masthead-subheading font-weight-light mb-0">Objek Wisata - Viral </p>
      </div>
    </header>
    <!-- Partner Section-->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 me-auto lead">
            <p>Di Kabupaten Sleman, tepatnya di Padukuhan Kurahan IV, Kalurahan Margodadi, Kapanewon Seyegan terdapat jembatan yang unik. Bukan terbuat dari konstruksi besi dan batu, melainkan dari akar pohon.</p>
    ...
    <footer class="footer text-center" id="profile">
      <div class="container">
        <div class="row">
          ...
          <!-- Footer About Text-->
          <div class="col-lg-4">
            <h4 class="text-uppercase mb-4">About Jembatan Akar</h4>
            <p class="lead mb-0">
              <a href="https://www.detik.com/jogja/plesir/d-6871083/eksotis-ada-jembatan-alami-memesona-dari-akar-pohon-di-sleman?single=1">Link</a>
              .
            </p>
          </div>
        </div>
